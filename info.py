...
UPDATES_LINK = environ.get('UPDATES_LINK', 'https://t.me/norFederationBot')
FILMS_LINK = environ.get('FILMS_LINK', 'https://t.me/norFederationBot')
...
STICKERS = [sticker for sticker in environ.get('STICKERS', 'CAACAgQAAxkBAAEO0RloYfr0lf_sZ0YKtsjZ-uUmcz9ZiQACHxoAAuL0EFPzNvGwAAH9JF42BA').split()]  # Multiple sticker can be used separated by space, use @idstickerbot for get sticker id
...
UPI_NAME = environ.get("UPI_NAME", "Aldrin") # add your UPI account name
if len(UPI_NAME) == 0:
    logger.info('UPI_NAME is empty')
RECEIPT_SEND_USERNAME = environ.get("RECEIPT_SEND_USERNAME", "@actualhomie")
